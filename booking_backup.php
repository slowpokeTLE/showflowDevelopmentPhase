...
<body style="background: var(--bg-primary);">
    <div class="booking-container">
        <div class="booking-header">
            ...
            <a href="user-dashboard.php" class="back-link">← Back to Movies</a>
        </div>
    ...
    <script>
            ...
            try {
                ...
                if (data.status === 'success' && data.data.shows.length > 0) {
                    ...
                    shows.forEach(show => {
                        ...
                        option.textContent = `${show.formatted_time} (${show.available_seats}/${show.total_seats} available)`;
        ...
        function renderSeatGrid(seatData) {
            ...
            for (let row = 0; row < rows; row++) {
                ...
                for (let col = 0; col < cols; col++) {
                    ...
                    html += `<div class="seat ${isBooked ? 'booked' : ''}" 
                        ...
                        ${isBooked ? '' : `onclick="toggleSeat('${seatId}', '${seatLabel}')"}`
                        title="${seatLabel}">
                        ${seatLabel}
                    </div>`;
                }
            ...
            html += '<div class="price-row"><span>Tax & Charges:</span><span id="taxDetail">--</span></div>';
        ...
        function updateSeatSummary() {
            ...
            if (selectedSeats.length === 0) {
                ...
                const ticketPrice = parseFloat(selectedOption.textContent.match(/\d+/)[0]) || 0;
                ...
                document.getElementById('taxDetail').textContent = `₹${tax}`;
