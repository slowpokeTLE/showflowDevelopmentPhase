                    ...
                    <div class="amount-section">
                        <div class="amount-input-group">
                            ...
                            <input type="number" id="amount" name="amount" placeholder="Enter amount" 
                                   min="10" max="100000" step="1" required
                                   value="<?php echo $suggested_amount > 0 ? $suggested_amount : ''; ?>">
                        </div>

                        <div>
                            <label style="font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; opacity: 0.7;">Quick Select</label>
                            <div class="preset-amounts">
                                <?php foreach ($preset_amounts as $amt): ?>
                                    <button type="button" class="preset-btn" onclick="document.getElementById('amount').value = <?php echo $amt; ?>">
                                        ৳<?php echo $amt; ?>
                                    </button>
                                <?php endforeach; ?>
                            </div>
